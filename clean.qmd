...
hiv_words <- data.frame(word = c("human", "immunodeficiency", "virus", "hiv", "aids", "acquired", "immunodeficiency", "syndrome", "disease", "diseases", "study", "trial", "randomized", "control", "patient", "review"))
```
